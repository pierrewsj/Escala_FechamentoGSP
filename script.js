...
function preencherDadosCargaPorColaborador() {
  ...
  if (!dados) {
    if ($('cargaDataInfo')) $('cargaDataInfo').textContent = formatarDataBR(dataISOHoje());
  ...
  if ($('cargaDataInfo')) $('cargaDataInfo').textContent = dados.dataBR;
