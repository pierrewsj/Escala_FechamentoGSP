...
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbyKzWJ-URubMVBSGhy_cHtFQtAeJuXDZJQN4SFK5yvkXMWC8uUho7S-sY1jWL0pz7c3IQ/exec';
...
async function salvarPlanilhaCargas() {
  ...
  try {
    const corpo = new URLSearchParams(payload);
